        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {user?.role === 'SUPERADMIN' && (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-500 truncate">Create and manage tenant accounts</p>
              </div>
            </a>
          )}
          <a
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 truncate">Check new customer inquiries</p>
            </div>
          </a>
          <a
            href="/projects"
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-gray-500 truncate">Manage active projects</p>
            </div>
          </a>
        </div>
      </div>
